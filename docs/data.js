(function () {
  ...
  // ---------------- Skills ----------------
  var SKILLS = {
    tackle: { id: "tackle", name: "たいあたり", power: 16, uses: 20, learnLevel: 1, desc: "体当たりで こうげきする" },
    sandkick: { id: "sandkick", name: "すなかけ", power: 22, uses: 20, learnLevel: 5, desc: "すなを かけて こうげきする", element: "earth" },
    headbutt: { id: "headbutt", name: "ずつき", power: 30, uses: 20, learnLevel: 12, desc: "頭突きで つよく こうげきする" },
    renzoku: { id: "renzoku", name: "れんぞくアタック", power: 40, uses: 10, learnLevel: 20, desc: "れんぞくで こうげきする", element: "thunder" },

    // ---- しんか専用わざ(なかよしルート) ----
    oyakodon_nage: { id: "oyakodon_nage", name: "おやこどんナゲット", power: 26, uses: 20, desc: "あつあつの ぐを なげつける" },
    myoga_giri: { id: "myoga_giri", name: "みょうがギリ", power: 34, uses: 20, desc: "しゃきしゃき きって こうげきする" },
    bagel_atk: { id: "bagel_atk", name: "ベーグルアタック", power: 44, uses: 10, desc: "かたい ベーグルを ぶつける" },
    yakiniku_fire: { id: "yakiniku_fire", name: "やきにくファイヤー", power: 54, uses: 10, desc: "あつい てっぱんで こんがり やく", element: "fire" },
    tofu_press: { id: "tofu_press", name: "とうふプレス", power: 66, uses: 10, desc: "ぷるぷるの とうふで おしつぶす" },

    // ---- しんか専用わざ(たくましいルート) ----
    itachi_slash: { id: "itachi_slash", name: "いたちスラッシュ", power: 26, uses: 20, desc: "するどい つめで きりさく" },
    kaeru_tongue: { id: "kaeru_tongue", name: "べろべろアタック", power: 34, uses: 20, desc: "ながい したで まきとって こうげきする" },
    kara_tackle: { id: "kara_tackle", name: "からがらタックル", power: 44, uses: 10, desc: "からに はいって いきおいよく ぶつかる" },
    orca_wave: { id: "orca_wave", name: "オルカウェーブ", power: 54, uses: 10, desc: "つめたい なみで おしながす", element: "water" },
    sai_charge: { id: "sai_charge", name: "サイクラッシュ", power: 66, uses: 10, desc: "つのを むけて つっこむ" },
    ...
    ice_shard: { id: "ice_shard", name: "こおりのつぶて", power: 22, uses: 20, learnLevel: 5, desc: "するどい こおりを ぶつける", element: "water" },

    // ---- 10属性 わざ一覧(初級/中級/上級/特級、なかまがレベルアップで習得) ----
    fire1_1: { id: "fire1_1", name: "ひのたま", power: 18, uses: 20, learnLevel: 1, desc: "ひのたまで こうげきする", element: "fire" },
    fire1_2: { id: "fire1_2", name: "ほのおのかべ", power: 21, uses: 20, learnLevel: 3, desc: "ほのおのかべで こうげきする", element: "fire" },
    fire1_3: { id: "fire1_3", name: "かえん", power: 24, uses: 20, learnLevel: 5, desc: "かえんで こうげきする", element: "fire" },
    fire1_4: { id: "fire1_4", name: "ほのおのちから", power: 27, uses: 20, learnLevel: 7, desc: "ほのおのちからで こうげきする", element: "fire" },
    fire1_5: { id: "fire1_5", name: "ねっせん", power: 30, uses: 20, learnLevel: 9, desc: "ねっせんで こうげきする", element: "fire" },
    fire2_1: { id: "fire2_1", name: "ほのおのうず", power: 34, uses: 20, learnLevel: 13, desc: "ほのおのうずで こうげきする", element: "fire" },
    fire2_2: { id: "fire2_2", name: "れんごく", power: 39, uses: 10, learnLevel: 17, desc: "れんごくで こうげきする", element: "fire" },
    fire2_3: { id: "fire2_3", name: "ひのもんじ", power: 44, uses: 10, learnLevel: 21, desc: "ひのもんじで こうげきする", element: "fire" },
    fire2_4: { id: "fire2_4", name: "フレア", power: 49, uses: 10, learnLevel: 25, desc: "フレアで こうげきする", element: "fire" },
    fire3_1: { id: "fire3_1", name: "メテオストライク", power: 56, uses: 10, learnLevel: 32, desc: "メテオストライクで こうげきする", element: "fire" },
    fire3_2: { id: "fire3_2", name: "かえんほうしゃ", power: 62, uses: 10, learnLevel: 36, desc: "かえんほうしゃで こうげきする", element: "fire" },
    fire3_3: { id: "fire3_3", name: "ほのおのけん", power: 68, uses: 10, learnLevel: 40, desc: "ほのおのけんで こうげきする", element: "fire" },
    fire3_4: { id: "fire3_4", name: "ぜいえんのつるぎ", power: 74, uses: 5, learnLevel: 44, desc: "ぜいえんのつるぎで こうげきする", element: "fire" },
    fire4_1: { id: "fire4_1", name: "プロミネンス", power: 82, uses: 5, learnLevel: 52, desc: "プロミネンスで こうげきする", element: "fire" },
    fire4_2: { id: "fire4_2", name: "ノヴァブラスト", power: 89, uses: 5, learnLevel: 56, desc: "ノヴァブラストで こうげきする", element: "fire" },
    fire4_3: { id: "fire4_3", name: "サンバースト", power: 96, uses: 5, learnLevel: 60, desc: "サンバーストで こうげきする", element: "fire" },
    fire4_4: { id: "fire4_4", name: "アルティメットフレア", power: 103, uses: 5, learnLevel: 64, desc: "アルティメットフレアで こうげきする", element: "fire" },

    water1_1: { id: "water1_1", name: "みずのはね", power: 18, uses: 20, learnLevel: 1, desc: "みずのはねで こうげきする", element: "water" },
    water1_2: { id: "water1_2", name: "みずでっぽう", power: 21, uses: 20, learnLevel: 3, desc: "みずでっぽうで こうげきする", element: "water" },
    water1_3: { id: "water1_3", name: "みずのまい", power: 24, uses: 20, learnLevel: 5, desc: "みずのまいで こうげきする", element: "water" },
    water1_4: { id: "water1_4", name: "すいしゅりけん", power: 27, uses: 20, learnLevel: 7, desc: "すいしゅりけんで こうげきする", element: "water" },
    water1_5: { id: "water1_5", name: "あわ", power: 30, uses: 20, learnLevel: 9, desc: "あわで こうげきする", element: "water" },
    water2_1: { id: "water2_1", name: "みずのうず", power: 34, uses: 20, learnLevel: 13, desc: "みずのうずで こうげきする", element: "water" },
    water2_2: { id: "water2_2", name: "スプラッシュ", power: 39, uses: 10, learnLevel: 17, desc: "スプラッシュで こうげきする", element: "water" },
    water2_3: { id: "water2_3", name: "ウォータージェット", power: 44, uses: 10, learnLevel: 21, desc: "ウォータージェットで こうげきする", element: "water" },
    water2_4: { id: "water2_4", name: "なみのり", power: 49, uses: 10, learnLevel: 25, desc: "なみのりで こうげきする", element: "water" },
    water2_5: { id: "water2_5", name: "しずくのカーテン", power: 54, uses: 10, learnLevel: 29, desc: "しずくのカーテンで こうげきする", element: "water" },
    water3_1: { id: "water3_1", name: "れいとうつぶて", power: 56, uses: 10, learnLevel: 32, desc: "れいとうつぶてで こうげきする", element: "water" },
    water3_2: { id: "water3_2", name: "アクアブレス", power: 62, uses: 10, learnLevel: 36, desc: "アクアブレスで こうげきする", element: "water" },
    water3_3: { id: "water3_3", name: "タイダルウェーブ", power: 68, uses: 10, learnLevel: 40, desc: "タイダルウェーブで こうげきする", element: "water" },
    water3_4: { id: "water3_4", name: "ウォーターやいば", power: 74, uses: 5, learnLevel: 44, desc: "ウォーターやいばで こうげきする", element: "water" },
    water4_1: { id: "water4_1", name: "オーシャンブレイク", power: 82, uses: 5, learnLevel: 52, desc: "オーシャンブレイクで こうげきする", element: "water" },
    water4_2: { id: "water4_2", name: "だいれいとう", power: 89, uses: 5, learnLevel: 56, desc: "だいれいとうで こうげきする", element: "water" },
    water4_3: { id: "water4_3", name: "アビスノヴァ", power: 96, uses: 5, learnLevel: 60, desc: "アビスノヴァで こうげきする", element: "water" },
    water4_4: { id: "water4_4", name: "しんすいのインパクト", power: 103, uses: 5, learnLevel: 64, desc: "しんすいのインパクトで こうげきする", element: "water" },

    grass1_1: { id: "grass1_1", name: "はっぱカッター", power: 18, uses: 20, learnLevel: 1, desc: "はっぱカッターで こうげきする", element: "grass" },
    grass1_2: { id: "grass1_2", name: "つるのムチ", power: 21, uses: 20, learnLevel: 3, desc: "つるのムチで こうげきする", element: "grass" },
    grass1_3: { id: "grass1_3", name: "タネばくだん", power: 24, uses: 20, learnLevel: 5, desc: "タネばくだんで こうげきする", element: "grass" },
    grass1_4: { id: "grass1_4", name: "せいちょう", power: 27, uses: 20, learnLevel: 7, desc: "せいちょうで こうげきする", element: "grass" },
    grass1_5: { id: "grass1_5", name: "どくのこな", power: 30, uses: 20, learnLevel: 9, desc: "どくのこなで こうげきする", element: "grass" },
    grass2_1: { id: "grass2_1", name: "つるのまきつき", power: 34, uses: 20, learnLevel: 13, desc: "つるのまきつきで こうげきする", element: "grass" },
    grass2_2: { id: "grass2_2", name: "はなふぶき", power: 39, uses: 10, learnLevel: 17, desc: "はなふぶきで こうげきする", element: "grass" },
    grass2_3: { id: "grass2_3", name: "しぜんのめぐみ", power: 44, uses: 10, learnLevel: 21, desc: "しぜんのめぐみで こうげきする", element: "grass" },
    grass2_4: { id: "grass2_4", name: "リーフブレード", power: 49, uses: 10, learnLevel: 25, desc: "リーフブレードで こうげきする", element: "grass" },
    grass3_1: { id: "grass3_1", name: "ジャングルブレス", power: 56, uses: 10, learnLevel: 32, desc: "ジャングルブレスで こうげきする", element: "grass" },
    grass3_2: { id: "grass3_2", name: "しぜんのいかり", power: 62, uses: 10, learnLevel: 36, desc: "しぜんのいかりで こうげきする", element: "grass" },
    grass3_3: { id: "grass3_3", name: "グラスフィールド", power: 68, uses: 10, learnLevel: 40, desc: "グラスフィールドで こうげきする", element: "grass" },
    grass3_4: { id: "grass3_4", name: "リーフストーム", power: 74, uses: 5, learnLevel: 44, desc: "リーフストームで こうげきする", element: "grass" },
    grass4_1: { id: "grass4_1", name: "ユグドラシル", power: 82, uses: 5, learnLevel: 52, desc: "ユグドラシルで こうげきする", element: "grass" },
    grass4_2: { id: "grass4_2", name: "グランドネイチャー", power: 89, uses: 5, learnLevel: 56, desc: "グランドネイチャーで こうげきする", element: "grass" },
    grass4_3: { id: "grass4_3", name: "フラワーヒール", power: 96, uses: 5, learnLevel: 60, desc: "フラワーヒールで こうげきする", element: "grass" },
    grass4_4: { id: "grass4_4", name: "ネイチャーズレイジ", power: 103, uses: 5, learnLevel: 64, desc: "ネイチャーズレイジで こうげきする", element: "grass" },

    wind1_1: { id: "wind1_1", name: "かぜおこし", power: 18, uses: 20, learnLevel: 1, desc: "かぜおこしで こうげきする", element: "wind" },
    wind1_2: { id: "wind1_2", name: "つむじかぜ", power: 21, uses: 20, learnLevel: 3, desc: "つむじかぜで こうげきする", element: "wind" },
    wind1_3: { id: "wind1_3", name: "かまいたち", power: 24, uses: 20, learnLevel: 5, desc: "かまいたちで こうげきする", element: "wind" },
    wind1_4: { id: "wind1_4", name: "すなぼこり", power: 27, uses: 20, learnLevel: 7, desc: "すなぼこりで こうげきする", element: "wind" },
    wind1_5: { id: "wind1_5", name: "はやて", power: 30, uses: 20, learnLevel: 9, desc: "はやてで こうげきする", element: "wind" },
    wind2_1: { id: "wind2_1", name: "ブリーズカッター", power: 34, uses: 20, learnLevel: 13, desc: "ブリーズカッターで こうげきする", element: "wind" },
    wind2_2: { id: "wind2_2", name: "エアスラッシュ", power: 39, uses: 10, learnLevel: 17, desc: "エアスラッシュで こうげきする", element: "wind" },
    wind2_3: { id: "wind2_3", name: "ウィンドカッター", power: 44, uses: 10, learnLevel: 21, desc: "ウィンドカッターで こうげきする", element: "wind" },
    wind2_4: { id: "wind2_4", name: "かぜのおどり", power: 49, uses: 10, learnLevel: 25, desc: "かぜのおどりで こうげきする", element: "wind" },
    wind3_1: { id: "wind3_1", name: "ストームフロー", power: 56, uses: 10, learnLevel: 32, desc: "ストームフローで こうげきする", element: "wind" },
    wind3_2: { id: "wind3_2", name: "スパイラルウィンド", power: 62, uses: 10, learnLevel: 36, desc: "スパイラルウィンドで こうげきする", element: "wind" },
    wind3_3: { id: "wind3_3", name: "エアブレイク", power: 68, uses: 10, learnLevel: 40, desc: "エアブレイクで こうげきする", element: "wind" },
    wind3_4: { id: "wind3_4", name: "ウィンドバースト", power: 74, uses: 5, learnLevel: 44, desc: "ウィンドバーストで こうげきする", element: "wind" },
    wind4_1: { id: "wind4_1", name: "エリアルレイヴ", power: 82, uses: 5, learnLevel: 52, desc: "エリアルレイヴで こうげきする", element: "wind" },
    wind4_2: { id: "wind4_2", name: "ハリケーンブレイク", power: 89, uses: 5, learnLevel: 56, desc: "ハリケーンブレイクで こうげきする", element: "wind" },
    wind4_3: { id: "wind4_3", name: "ウィンドブレード", power: 96, uses: 5, learnLevel: 60, desc: "ウィンドブレードで こうげきする", element: "wind" },
    wind4_4: { id: "wind4_4", name: "エターナルストーム", power: 103, uses: 5, learnLevel: 64, desc: "エターナルストームで こうげきする", element: "wind" },

    earth1_1: { id: "earth1_1", name: "どろだんご", power: 18, uses: 20, learnLevel: 1, desc: "どろだんごで こうげきする", element: "earth" },
    earth1_2: { id: "earth1_2", name: "いわおとし", power: 21, uses: 20, learnLevel: 3, desc: "いわおとしで こうげきする", element: "earth" },
    earth1_3: { id: "earth1_3", name: "どろかけ", power: 24, uses: 20, learnLevel: 5, desc: "どろかけで こうげきする", element: "earth" },
    earth1_4: { id: "earth1_4", name: "すなじごく", power: 27, uses: 20, learnLevel: 7, desc: "すなじごくで こうげきする", element: "earth" },
    earth2_1: { id: "earth2_1", name: "いわなだれ", power: 34, uses: 20, learnLevel: 13, desc: "いわなだれで こうげきする", element: "earth" },
    earth2_2: { id: "earth2_2", name: "マッドショット", power: 39, uses: 10, learnLevel: 17, desc: "マッドショットで こうげきする", element: "earth" },
    earth2_3: { id: "earth2_3", name: "どろのうず", power: 44, uses: 10, learnLevel: 21, desc: "どろのうずで こうげきする", element: "earth" },
    earth2_4: { id: "earth2_4", name: "ストーンエッジ", power: 49, uses: 10, learnLevel: 25, desc: "ストーンエッジで こうげきする", element: "earth" },
    earth2_5: { id: "earth2_5", name: "じしん", power: 54, uses: 10, learnLevel: 29, desc: "じしんで こうげきする", element: "earth" },
    earth3_1: { id: "earth3_1", name: "ロックブラスト", power: 56, uses: 10, learnLevel: 32, desc: "ロックブラストで こうげきする", element: "earth" },
    earth3_2: { id: "earth3_2", name: "アースクエイク", power: 62, uses: 10, learnLevel: 36, desc: "アースクエイクで こうげきする", element: "earth" },
    earth3_3: { id: "earth3_3", name: "アースウォール", power: 68, uses: 10, learnLevel: 40, desc: "アースウォールで こうげきする", element: "earth" },
    earth3_4: { id: "earth3_4", name: "すいちょくのちから", power: 74, uses: 5, learnLevel: 44, desc: "すいちょくのちからで こうげきする", element: "earth" },
    earth4_1: { id: "earth4_1", name: "テラノヴァブレイク", power: 82, uses: 5, learnLevel: 52, desc: "テラノヴァブレイクで こうげきする", element: "earth" },
    earth4_2: { id: "earth4_2", name: "グランドクラッシュ", power: 89, uses: 5, learnLevel: 56, desc: "グランドクラッシュで こうげきする", element: "earth" },
    earth4_3: { id: "earth4_3", name: "メガトンロック", power: 96, uses: 5, learnLevel: 60, desc: "メガトンロックで こうげきする", element: "earth" },
    earth4_4: { id: "earth4_4", name: "ガイアインパクト", power: 103, uses: 5, learnLevel: 64, desc: "ガイアインパクトで こうげきする", element: "earth" },

    thunder1_1: { id: "thunder1_1", name: "でんきショック", power: 18, uses: 20, learnLevel: 1, desc: "でんきショックで こうげきする", element: "thunder" },
    thunder1_2: { id: "thunder1_2", name: "スパーク", power: 21, uses: 20, learnLevel: 3, desc: "スパークで こうげきする", element: "thunder" },
    thunder1_3: { id: "thunder1_3", name: "ライトボルト", power: 24, uses: 20, learnLevel: 5, desc: "ライトボルトで こうげきする", element: "thunder" },
    thunder1_4: { id: "thunder1_4", name: "サンダージャブ", power: 27, uses: 20, learnLevel: 7, desc: "サンダージャブで こうげきする", element: "thunder" },
    thunder1_5: { id: "thunder1_5", name: "エレキボール", power: 30, uses: 20, learnLevel: 9, desc: "エレキボールで こうげきする", element: "thunder" },
    thunder2_1: { id: "thunder2_1", name: "サンダーウェーブ", power: 34, uses: 20, learnLevel: 13, desc: "サンダーウェーブで こうげきする", element: "thunder" },
    thunder2_2: { id: "thunder2_2", name: "チェインライト", power: 39, uses: 10, learnLevel: 17, desc: "チェインライトで こうげきする", element: "thunder" },
    thunder2_3: { id: "thunder2_3", name: "ライトニングランス", power: 44, uses: 10, learnLevel: 21, desc: "ライトニングランスで こうげきする", element: "thunder" },
    thunder2_4: { id: "thunder2_4", name: "エレキフィールド", power: 49, uses: 10, learnLevel: 25, desc: "エレキフィールドで こうげきする", element: "thunder" },
    thunder2_5: { id: "thunder2_5", name: "サンダーアロー", power: 54, uses: 10, learnLevel: 29, desc: "サンダーアローで こうげきする", element: "thunder" },
    thunder3_1: { id: "thunder3_1", name: "ライトニングブレイク", power: 56, uses: 10, learnLevel: 32, desc: "ライトニングブレイクで こうげきする", element: "thunder" },
    thunder3_2: { id: "thunder3_2", name: "サンダーストーム", power: 62, uses: 10, learnLevel: 36, desc: "サンダーストームで こうげきする", element: "thunder" },
    thunder3_3: { id: "thunder3_3", name: "ボルトスピア", power: 68, uses: 10, learnLevel: 40, desc: "ボルトスピアで こうげきする", element: "thunder" },
    thunder3_4: { id: "thunder3_4", name: "サンダーレイン", power: 74, uses: 5, learnLevel: 44, desc: "サンダーレインで こうげきする", element: "thunder" },
    thunder3_5: { id: "thunder3_5", name: "イナズマクラッシュ", power: 80, uses: 5, learnLevel: 48, desc: "イナズマクラッシュで こうげきする", element: "thunder" },
    thunder4_1: { id: "thunder4_1", name: "ギガボルト", power: 82, uses: 5, learnLevel: 52, desc: "ギガボルトで こうげきする", element: "thunder" },
    thunder4_2: { id: "thunder4_2", name: "らいていばんきん", power: 89, uses: 5, learnLevel: 56, desc: "らいていばんきんで こうげきする", element: "thunder" },
    thunder4_3: { id: "thunder4_3", name: "ライトニングノヴァ", power: 96, uses: 5, learnLevel: 60, desc: "ライトニングノヴァで こうげきする", element: "thunder" },
    thunder4_4: { id: "thunder4_4", name: "カミナリイカヅチ", power: 103, uses: 5, learnLevel: 64, desc: "カミナリイカヅチで こうげきする", element: "thunder" },
    thunder4_5: { id: "thunder4_5", name: "アルティメットサンダー", power: 110, uses: 5, learnLevel: 68, desc: "アルティメットサンダーで こうげきする", element: "thunder" },

    heaven1_1: { id: "heaven1_1", name: "ヒーリングライト", power: 18, uses: 20, learnLevel: 1, desc: "ヒーリングライトで こうげきする", element: "heaven" },
    heaven1_2: { id: "heaven1_2", name: "ピュアフラッシュ", power: 21, uses: 20, learnLevel: 3, desc: "ピュアフラッシュで こうげきする", element: "heaven" },
    heaven1_3: { id: "heaven1_3", name: "セイントビーム", power: 24, uses: 20, learnLevel: 5, desc: "セイントビームで こうげきする", element: "heaven" },
    heaven1_4: { id: "heaven1_4", name: "ホーリーガード", power: 27, uses: 20, learnLevel: 7, desc: "ホーリーガードで こうげきする", element: "heaven" },
    heaven1_5: { id: "heaven1_5", name: "ラディアンス", power: 30, uses: 20, learnLevel: 9, desc: "ラディアンスで こうげきする", element: "heaven" },
    heaven2_1: { id: "heaven2_1", name: "プラズマヒール", power: 34, uses: 20, learnLevel: 13, desc: "プラズマヒールで こうげきする", element: "heaven" },
    heaven2_2: { id: "heaven2_2", name: "セイントクロス", power: 39, uses: 10, learnLevel: 17, desc: "セイントクロスで こうげきする", element: "heaven" },
    heaven2_3: { id: "heaven2_3", name: "ホーリーランス", power: 44, uses: 10, learnLevel: 21, desc: "ホーリーランスで こうげきする", element: "heaven" },
    heaven2_4: { id: "heaven2_4", name: "ディバインシールド", power: 49, uses: 10, learnLevel: 25, desc: "ディバインシールドで こうげきする", element: "heaven" },
    heaven2_5: { id: "heaven2_5", name: "シャイニングサークル", power: 54, uses: 10, learnLevel: 29, desc: "シャイニングサークルで こうげきする", element: "heaven" },
    heaven3_1: { id: "heaven3_1", name: "セイクリッドレイ", power: 56, uses: 10, learnLevel: 32, desc: "セイクリッドレイで こうげきする", element: "heaven" },
    heaven3_2: { id: "heaven3_2", name: "ライトオブヘブン", power: 62, uses: 10, learnLevel: 36, desc: "ライトオブヘブンで こうげきする", element: "heaven" },
    heaven3_3: { id: "heaven3_3", name: "ホーリーストーム", power: 68, uses: 10, learnLevel: 40, desc: "ホーリーストームで こうげきする", element: "heaven" },
    heaven3_4: { id: "heaven3_4", name: "ルミナスブレイク", power: 74, uses: 5, learnLevel: 44, desc: "ルミナスブレイクで こうげきする", element: "heaven" },
    heaven3_5: { id: "heaven3_5", name: "ジャッジメント", power: 80, uses: 5, learnLevel: 48, desc: "ジャッジメントで こうげきする", element: "heaven" },
    heaven4_1: { id: "heaven4_1", name: "セイクリッドノヴァ", power: 82, uses: 5, learnLevel: 52, desc: "セイクリッドノヴァで こうげきする", element: "heaven" },
    heaven4_2: { id: "heaven4_2", name: "ヘブンズゲート", power: 89, uses: 5, learnLevel: 56, desc: "ヘブンズゲートで こうげきする", element: "heaven" },
    heaven4_3: { id: "heaven4_3", name: "ラストライト", power: 96, uses: 5, learnLevel: 60, desc: "ラストライトで こうげきする", element: "heaven" },
    heaven4_4: { id: "heaven4_4", name: "スターライトエクスプロード", power: 103, uses: 5, learnLevel: 64, desc: "スターライトエクスプロードで こうげきする", element: "heaven" },
    heaven4_5: { id: "heaven4_5", name: "アルティメットセイバー", power: 110, uses: 5, learnLevel: 68, desc: "アルティメットセイバーで こうげきする", element: "heaven" },

    dark1_1: { id: "dark1_1", name: "ダークショット", power: 18, uses: 20, learnLevel: 1, desc: "ダークショットで こうげきする", element: "dark" },
    dark1_2: { id: "dark1_2", name: "ナイトミスト", power: 21, uses: 20, learnLevel: 3, desc: "ナイトミストで こうげきする", element: "dark" },
    dark1_3: { id: "dark1_3", name: "ダークスラッシュ", power: 24, uses: 20, learnLevel: 5, desc: "ダークスラッシュで こうげきする", element: "dark" },
    dark1_4: { id: "dark1_4", name: "カースアイ", power: 27, uses: 20, learnLevel: 7, desc: "カースアイで こうげきする", element: "dark" },
    dark1_5: { id: "dark1_5", name: "ソウルドレイン", power: 30, uses: 20, learnLevel: 9, desc: "ソウルドレインで こうげきする", element: "dark" },
    dark2_1: { id: "dark2_1", name: "シャドウウェーブ", power: 34, uses: 20, learnLevel: 13, desc: "シャドウウェーブで こうげきする", element: "dark" },
    dark2_2: { id: "dark2_2", name: "ダークバインド", power: 39, uses: 10, learnLevel: 17, desc: "ダークバインドで こうげきする", element: "dark" },
    dark2_3: { id: "dark2_3", name: "ドレインタッチ", power: 44, uses: 10, learnLevel: 21, desc: "ドレインタッチで こうげきする", element: "dark" },
    dark2_4: { id: "dark2_4", name: "カースフィールド", power: 49, uses: 10, learnLevel: 25, desc: "カースフィールドで こうげきする", element: "dark" },
    dark2_5: { id: "dark2_5", name: "ダークサークル", power: 54, uses: 10, learnLevel: 29, desc: "ダークサークルで こうげきする", element: "dark" },
    dark3_1: { id: "dark3_1", name: "ダークネスストライク", power: 56, uses: 10, learnLevel: 32, desc: "ダークネスストライクで こうげきする", element: "dark" },
    dark3_2: { id: "dark3_2", name: "ソウルサクリファイス", power: 62, uses: 10, learnLevel: 36, desc: "ソウルサクリファイスで こうげきする", element: "dark" },
    dark3_3: { id: "dark3_3", name: "デスウェーブ", power: 68, uses: 10, learnLevel: 40, desc: "デスウェーブで こうげきする", element: "dark" },
    dark3_4: { id: "dark3_4", name: "カースブラスト", power: 74, uses: 5, learnLevel: 44, desc: "カースブラストで こうげきする", element: "dark" },
    dark3_5: { id: "dark3_5", name: "シャドウフォール", power: 80, uses: 5, learnLevel: 48, desc: "シャドウフォールで こうげきする", element: "dark" },
    dark4_1: { id: "dark4_1", name: "ダークネスノヴァ", power: 82, uses: 5, learnLevel: 52, desc: "ダークネスノヴァで こうげきする", element: "dark" },
    dark4_2: { id: "dark4_2", name: "デーモンズゲイト", power: 89, uses: 5, learnLevel: 56, desc: "デーモンズゲイトで こうげきする", element: "dark" },
    dark4_3: { id: "dark4_3", name: "ソウルイクリプス", power: 96, uses: 5, learnLevel: 60, desc: "ソウルイクリプスで こうげきする", element: "dark" },
    dark4_4: { id: "dark4_4", name: "ワールドオブダーク", power: 103, uses: 5, learnLevel: 64, desc: "ワールドオブダークで こうげきする", element: "dark" },
    dark4_5: { id: "dark4_5", name: "アルティメットダークネス", power: 110, uses: 5, learnLevel: 68, desc: "アルティメットダークネスで こうげきする", element: "dark" },

    magic1_1: { id: "magic1_1", name: "マジックミサイル", power: 18, uses: 20, learnLevel: 1, desc: "マジックミサイルで こうげきする", element: "magic" },
    magic1_2: { id: "magic1_2", name: "マジックアロー", power: 21, uses: 20, learnLevel: 3, desc: "マジックアローで こうげきする", element: "magic" },
    magic1_3: { id: "magic1_3", name: "マジックブレット", power: 24, uses: 20, learnLevel: 5, desc: "マジックブレットで こうげきする", element: "magic" },
    magic1_4: { id: "magic1_4", name: "マジックシールド", power: 27, uses: 20, learnLevel: 7, desc: "マジックシールドで こうげきする", element: "magic" },
    magic1_5: { id: "magic1_5", name: "スリープ", power: 30, uses: 20, learnLevel: 9, desc: "スリープで こうげきする", element: "magic" },
    magic2_1: { id: "magic2_1", name: "マジックウェーブ", power: 34, uses: 20, learnLevel: 13, desc: "マジックウェーブで こうげきする", element: "magic" },
    magic2_2: { id: "magic2_2", name: "エレメンタルボルト", power: 39, uses: 10, learnLevel: 17, desc: "エレメンタルボルトで こうげきする", element: "magic" },
    magic2_3: { id: "magic2_3", name: "マナバースト", power: 44, uses: 10, learnLevel: 21, desc: "マナバーストで こうげきする", element: "magic" },
    magic2_4: { id: "magic2_4", name: "マジックサークル", power: 49, uses: 10, learnLevel: 25, desc: "マジックサークルで こうげきする", element: "magic" },
    magic2_5: { id: "magic2_5", name: "テレポート", power: 54, uses: 10, learnLevel: 29, desc: "テレポートで こうげきする", element: "magic" },
    magic3_1: { id: "magic3_1", name: "メテオ", power: 56, uses: 10, learnLevel: 32, desc: "メテオで こうげきする", element: "magic" },
    magic3_2: { id: "magic3_2", name: "メイルストロム", power: 62, uses: 10, learnLevel: 36, desc: "メイルストロムで こうげきする", element: "magic" },
    magic3_3: { id: "magic3_3", name: "マジックカノン", power: 68, uses: 10, learnLevel: 40, desc: "マジックカノンで こうげきする", element: "magic" },
    magic3_4: { id: "magic3_4", name: "マジックオーブ", power: 74, uses: 5, learnLevel: 44, desc: "マジックオーブで こうげきする", element: "magic" },
    magic3_5: { id: "magic3_5", name: "ディメンションゲート", power: 80, uses: 5, learnLevel: 48, desc: "ディメンションゲートで こうげきする", element: "magic" },
    magic4_1: { id: "magic4_1", name: "メテオストーム", power: 82, uses: 5, learnLevel: 52, desc: "メテオストームで こうげきする", element: "magic" },
    magic4_2: { id: "magic4_2", name: "カオスバースト", power: 89, uses: 5, learnLevel: 56, desc: "カオスバーストで こうげきする", element: "magic" },
    magic4_3: { id: "magic4_3", name: "アルカナノヴァ", power: 96, uses: 5, learnLevel: 60, desc: "アルカナノヴァで こうげきする", element: "magic" },
    magic4_4: { id: "magic4_4", name: "マナブレイク", power: 103, uses: 5, learnLevel: 64, desc: "マナブレイクで こうげきする", element: "magic" },
    magic4_5: { id: "magic4_5", name: "アルティメットマジック", power: 110, uses: 5, learnLevel: 68, desc: "アルティメットマジックで こうげきする", element: "magic" },

    beast1_1: { id: "beast1_1", name: "ひっかき", power: 18, uses: 20, learnLevel: 1, desc: "ひっかきで こうげきする", element: "beast" },
    beast1_2: { id: "beast1_2", name: "かみつき", power: 21, uses: 20, learnLevel: 3, desc: "かみつきで こうげきする", element: "beast" },
    beast1_3: { id: "beast1_3", name: "しっぽアタック", power: 24, uses: 20, learnLevel: 5, desc: "しっぽアタックで こうげきする", element: "beast" },
    beast1_4: { id: "beast1_4", name: "つきとばし", power: 27, uses: 20, learnLevel: 7, desc: "つきとばしで こうげきする", element: "beast" },
    beast1_5: { id: "beast1_5", name: "いかりのほえ", power: 30, uses: 20, learnLevel: 9, desc: "いかりのほえで こうげきする", element: "beast" },
    beast2_1: { id: "beast2_1", name: "とびかかり", power: 34, uses: 20, learnLevel: 13, desc: "とびかかりで こうげきする", element: "beast" },
    beast2_2: { id: "beast2_2", name: "つめとぎ", power: 39, uses: 10, learnLevel: 17, desc: "つめとぎで こうげきする", element: "beast" },
    beast2_3: { id: "beast2_3", name: "らんぺージ", power: 44, uses: 10, learnLevel: 21, desc: "らんぺージで こうげきする", element: "beast" },
    beast2_4: { id: "beast2_4", name: "ロアー", power: 49, uses: 10, learnLevel: 25, desc: "ロアーで こうげきする", element: "beast" },
    beast2_5: { id: "beast2_5", name: "ダッシュクロー", power: 54, uses: 10, learnLevel: 29, desc: "ダッシュクローで こうげきする", element: "beast" },
    beast3_1: { id: "beast3_1", name: "ハウリングブロー", power: 56, uses: 10, learnLevel: 32, desc: "ハウリングブローで こうげきする", element: "beast" },
    beast3_2: { id: "beast3_2", name: "ビーストファング", power: 62, uses: 10, learnLevel: 36, desc: "ビーストファングで こうげきする", element: "beast" },
    beast3_3: { id: "beast3_3", name: "ワイルドチャージ", power: 68, uses: 10, learnLevel: 40, desc: "ワイルドチャージで こうげきする", element: "beast" },
    beast3_4: { id: "beast3_4", name: "かみくだき", power: 74, uses: 5, learnLevel: 44, desc: "かみくだきで こうげきする", element: "beast" },
    beast3_5: { id: "beast3_5", name: "ビーストラッシュ", power: 80, uses: 5, learnLevel: 48, desc: "ビーストラッシュで こうげきする", element: "beast" },
    beast4_1: { id: "beast4_1", name: "フューリーストライク", power: 82, uses: 5, learnLevel: 52, desc: "フューリーストライクで こうげきする", element: "beast" },
    beast4_2: { id: "beast4_2", name: "キングオブビースト", power: 89, uses: 5, learnLevel: 56, desc: "キングオブビーストで こうげきする", element: "beast" },
    beast4_3: { id: "beast4_3", name: "プライマルブレイク", power: 96, uses: 5, learnLevel: 60, desc: "プライマルブレイクで こうげきする", element: "beast" },
    beast4_4: { id: "beast4_4", name: "デスハウル", power: 103, uses: 5, learnLevel: 64, desc: "デスハウルで こうげきする", element: "beast" },
    beast4_5: { id: "beast4_5", name: "アルティメットビースト", power: 110, uses: 5, learnLevel: 68, desc: "アルティメットビーストで こうげきする", element: "beast" }
  };
  ...
  var ITEMS = {
    ...
    manashizuku: { id: "manashizuku", name: "マナのしずく", desc: "えらんだ わざの のこり回数を 8かいふくする", kind: "pp", amount: 8, price: 25, icon: "assets/items/icon_manashizuku.webp" },
    ...
    high_mana: { id: "high_mana", name: "せいれいの けっしょう", desc: "えらんだ わざの のこり回数を 15かいふくする", kind: "pp", amount: 15, price: 70, icon: "assets/items/icon_high_mana.webp" },
    elixir: { id: "elixir", name: "エリクサー", desc: "HPと 覚えている わざの 回数を ぜんかい かいふくする", kind: "full", icon: "assets/items/icon_elixir.webp" },
